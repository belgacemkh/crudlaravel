...
<main class="container">
        <section>
            ...
            <div class="table">
                ...
                <form action="{{ route('products.index')}}" accept-charsert="UTF-8" role="search">
                    ...
                    @if (count($products)>0)
                        @foreach ($products as $product)
                            ...
                            <div style="display:flex">     
                                ...
                                <form method ="post" action="{{ route('products.destroy', $product->id) }}" id="deletproduct{{$product->id}}">
                                    @method('delete')
                                    @csrf
